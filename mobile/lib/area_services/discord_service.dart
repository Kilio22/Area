...
class DiscordService extends Service {
  const DiscordService() : super('Discord', null, null, null, null, null, false, true);
  ...
  AreaServiceWidgetBase createServiceWidgetInstance(StreamController<Map<String, dynamic>> streamParamsController, bool isAction,
    ...
    return ServiceWidgetFactory.createServiceWidgetInstance('discord', streamParamsController, isAction, params);
  }
}
